    ...
    <?php if (!empty($header_class)) : ?>
        ...
        <?php else : ?>
            ...
            <nav>
                ...
                <?php get_template_part('view/components/global-navi/menu-list'); ?>
            ...
            <nav class="drawer">
                ...
                <section class="drawer-list">
                    ...
                    <div class="drawer-link">
                        <?php if (is_page('recruit')) : ?>
                            <?php get_template_part('view/components/global-navi/menu-list-recruit'); ?>
                        <?php else : ?>
                            <?php get_template_part('view/components/global-navi/menu-list-mb.php'); ?>
                        <?php endif; ?>
                    </div>
                </section>
            </nav>
            ...
            <?php if (is_home() || is_front_page()) : ?>
                <?php get_template_part('view/components/main-visual/top'); ?>
            <?php else : ?>
                <?php if (is_page('recruit')) : ?>
                    <?php get_template_part('view/components/global-navi/menu-list-recruit'); ?>
                <?php else : ?>
                    <?php get_template_part('view/components/main-visual/page'); ?>
                <?php endif; ?>
            <?php endif; ?>
