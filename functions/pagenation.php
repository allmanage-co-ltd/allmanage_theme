...
// ページネーション
function wp_pagination($pages = '', $range = 5): void
{
  // ページ情報の取得
  global $paged;
  if (empty($paged)) {
  ...
  $page_plus = (0 === $range % 2) ? $page_minus + 1 : $page_minus;
...
function print_page_loop($active, $value): void
{
  if ($active === $value) {
