 ...
 */
function disable_wp_auto_title()
{
  remove_theme_support('title-tag');
}
add_action('after_setup_theme', 'disable_wp_auto_title');
...
{
  $default_image = get_template_directory_uri() . '/src/img/common/ogp.jpg';
  $ogp_image = '';
...
/**
 * JSON-LD構造化データを出力する関数
 */
function get_jsonld()
{
  $site_name = get_bloginfo('name');
  $site_url = home_url();
  $logo_url = get_template_directory_uri() . '/src/img/common/logo.png';
  ...
  $encoded_jsonld = json_encode($json_ld, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
